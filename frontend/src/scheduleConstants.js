...
export const SCHEDULE_LEGEND_ITEMS = [
  ...
  { bg: "#EEF2EA", border: "#C9D4BE", label: "Shift 1 · Sessions (8–12)" },
  { bg: "#E8EDE3", border: "#C3CFBA", label: "Shift 2 · Sessions (12–4)" },
  { bg: "#E2E8DC", border: "#BDC9B5", label: "Shift 3 · Sessions (4–8)" },
