...
export default function Login() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] flex flex-col lg:flex-row bg-organic login-page">
      {/* Green branding panel — top on mobile, left on desktop */}
      <div
        className="lg:w-1/2 lg:min-h-[100dvh] flex flex-col justify-center text-white py-10 sm:py-14 px-6 relative overflow-hidden shrink-0"
      ...
      >
        ...
        <div className="max-w-lg mx-auto lg:mx-0 lg:ml-[max(1.5rem,calc((100%-32rem)/2))] relative w-full">
          ...
          <div className="mt-8 lg:mt-10">
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-semibold leading-[1.1]">
      ...
      {/* Login form — vertically centered on all screen sizes */}
      <div className="flex-1 flex flex-col justify-center min-h-[50vh] min-h-[100dvh] lg:min-h-[100dvh] px-4 py-8 sm:py-10">
